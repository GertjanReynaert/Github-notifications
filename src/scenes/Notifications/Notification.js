...
import issueIcon
  from '../../assets/octicons_4-3-0_issue-opened_128_0_000000_none.png';
import pullRequestIcon
  from '../../assets/octicons_4-3-0_git-pull-request_128_0_000000_none.png';
import commitIcon
  from '../../assets/octicons_4-3-0_git-commit_128_0_000000_none.png';
    ...
    return (
      <View style={styles.wrapper}>
        <View style={styles.left}>
          <Image
            source={icon.icon}
            style={[styles.icon, { tintColor: icon.color }]}
          />
